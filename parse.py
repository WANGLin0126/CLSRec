...
def parse_args():
    ...
    parser.add_argument('-m', '--model', type=str, default='CSRec')
    ...
    parser.add_argument('--cl_weight', type=float, default=1e-5, help="the weight for contrastive loss")
    parser.add_argument('--percentage', type=float, default=0.01, help="the percentage of training data")
    ...
    parser.add_argument('--testbatch', type=str, default=100, help="the batch size of users for testing")
