# CLSRec - Contrastive Learning Social Recommendation 
...
*Figure 1: Our proposed contrastive learning social recommendation (**CLSRec**) framework.*
...
`python main.py --model=CLSRec --dataset=lastfm --decay=1e-4 --lr=0.001 --layer=3 --seed=2020 --topks="[10,20]" --recdim=64 --bpr_batch=2048`
